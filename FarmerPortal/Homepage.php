...
<body>
     ...
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;">@Bajekosabji</a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">Bajekosabji@gmail.com</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="text-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.Bajekosabji.com</h5>
     </div>

            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Nardeep</h4>
                        <p class="card-text text-center">Damak, Jhapa<br><br>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Suyog</h4>
                        <p class="card-text text-center">Damak, Jhapa<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Prashant</h4>
                        <p class="card-text text-center">Damak, Jhapa<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Narottam</h4>
                        <p class="card-text text-center">Kathmandu, Nepal<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
                      <a href="#" class="card-link text-center">Another link</a> -->
